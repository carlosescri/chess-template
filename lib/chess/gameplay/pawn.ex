defmodule Chess.Gameplay.Pawn do
  @moduledoc """
  Pawn
  """
  ...
  defp has_piece_of_colour?(board, pos, colour) do
    Board.piece(board, pos) |> matches_colour?(colour)
  end
  ...
  defp attacks(
         ...
         %{
            ...
            start_p: {sc, sr},
            end_p: {_ec, er}
         }) when sr == 6 and (sc == c - 1 or sc == c + 1) and er == 4 do
    [{sc, 5} | attacks(board, :white, {c, 4}, [])]
  end
  ...
  defp attacks(
         ...
         %{
            ...
            start_p: {sc, sr},
            end_p: {_ec, er}
          }) when sr == 1 and (sc == c - 1 or sc == c + 1) and er == 3 do
    [{sc, 2} | attacks(board, :black, {c, 3}, [])]
  end
