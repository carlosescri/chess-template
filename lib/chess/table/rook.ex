defmodule Chess.Table.Rook do
  ...
  defp move_up_straight_one_step(_pieces, _column, row, moves, _color) when row == 8 do moves end
  ...
  defp move_right_one_step(_pieces, column_index, _row, moves, _color) when column_index == 7 do moves end
  ...
  defp move_down_straight_one_step(_pieces, _column, row, moves, _color) when row == 1 do moves end
  ...
  defp move_left_one_step(_pieces, column_index, _row, moves, _color) when column_index == 0 do moves end
