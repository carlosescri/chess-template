defmodule Chess.Game.Movements do
  ...
  def allowed?(_, _, %{coordinates: {to_col, to_row}}) when not in_bounds(to_col, to_row), do: false
  ...
  def allowed?(board, %{figure: %{type: :bishop}, coordinates: {from_col, from_row}}, %{coordinates: {to_col, to_row}}) do
    false
  end

  def allowed?(board, %{figure: %{type: :queen}, coordinates: {from_col, from_row}}, %{coordinates: {to_col, to_row}}) do
    false
  end

  def allowed?(board, %{figure: %{type: :king}, coordinates: {from_col, from_row}}, %{coordinates: {to_col, to_row}}) do
    false
  end

  def allowed?(board, %{figure: %{type: :pawn}, coordinates: {from_col, from_row}}, %{coordinates: {to_col, to_row}}) do
    false
  end

  def allowed?(_board, %{figure: %{type: :rook}, coordinates: {col, _from_row}}, %{coordinates: {col, _to_row}}) do
    true
  end

  def allowed?(_board, %{figure: %{type: :rook}, coordinates: {_from_col, row}}, %{coordinates: {_to_col, row}}) do
    true
  end
